...
var gameEnd = false;
var gameStart = true;
//To clear the previously used interval when new interval starts
var globalInterval;
...
function startGame() {
	...
	let interval = setInterval(function () {
		...
		drawStuff();
	}, parseInt(1000 / framesPerSecond)); //makes the function call every 1000/frames milliseconds
